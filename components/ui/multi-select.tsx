...
// Função auxiliar para transformar o objeto retornado do backend em TagOption.
...
export function TagsMultiselect({
  ...
  // Atualiza as tags selecionadas sempre que o valor ou as opções disponíveis mudam.
  React.useEffect(() => {
  ...
  // Função para buscar tags no backend.
  ...
  // Carrega as tags assim que o componente é montado.
  React.useEffect(() => {
    fetchTags();
  }, []);
  ...
  const handleCreateNew = async () => {
    ...
    try {
      ...
      // Atualiza a lista de tags após a criação.
      await fetchTags();
      setNewTagName("");
    } catch (error) {
